...
test_that("create_index works with datasets", {
  ...
  t_tennis_agresti <- as.data.frame(tibble::tribble(~player0, ~player1, ~wins_player0, ~wins_player1, ~player0_index, ~player1_index,
                                                    'Seles', 'Graf', 2, 3, 1, 2,
  ...
  expect_equal(create_index(tennis_agresti, player0='player0', player1='player1'), t_tennis_agresti)
})
...
test_that("compute_score works with datasets", {
  ...
  t_tennis_agresti <- as.data.frame(tibble::tribble(~y,1,0,2,0,0,0,0,1,0,0))
  ...
  expect_equal(compute_scores(tennis_agresti, player0_score='wins_player0', player1_score='wins_player1',solve_ties='none', win_score='higher')$y, t_tennis_agresti$y)
  expect_equal(compute_scores(tennis_agresti, player0_score='wins_player0', player1_score='wins_player1',solve_ties='remove', win_score='higher')$y, t_tennis_agresti_remove$y)

  set.seed(1)#0 won in the draw
  expect_equal(compute_scores(tennis_agresti, player0_score='wins_player0', player1_score='wins_player1',solve_ties='random', win_score='higher')$y, t_tennis_agresti_0won$y)

  set.seed(4)#1 won in the draw
  expect_equal(compute_scores(tennis_agresti, player0_score='wins_player0', player1_score='wins_player1',solve_ties='random', win_score='higher')$y, t_tennis_agresti_1won$y)
