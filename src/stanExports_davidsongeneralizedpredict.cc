...
#include "stanExports_davidsongeneralizedpredict.h"

RCPP_MODULE(stan_fit4davidsongeneralizedpredict_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_davidsongeneralizedpredict")
