...
namespace model_davidsonU_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_davidsonU");
    reader.add_event(107, 105, "end", "model_davidsonU");
    return reader;
}
#include <stan_meta_header.hpp>
class model_davidsonU
  : public stan::model::model_base_crtp<model_davidsonU> {
private:
        int N_total;
        std::vector<int> y;
        int N_players;
        ...
        double prior_nu_mu;
public:
    model_davidsonU(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_davidsonU_namespace::model_davidsonU";
        ...
        try {
            ...
            validate_non_negative_index("U_indexes", "N_total", N_total);
            context__.validate_dims("data initialization", "U_indexes", "int", context__.to_vec(N_total));
            U_indexes = std::vector<int>(N_total, int(0));
            vals_i__ = context__.vals_i("U_indexes");
            pos__ = 0;
            size_t U_indexes_k_0_max__ = N_total;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(U_std, 0, prior_U_std));
            ...
            for (int i = 1; i <= N_players; ++i) {
                ...
                for (int j = 1; j <= N_U; ++j) {
                    ...
                    lp_accum__.add(normal_log<propto__>(get_base1(U, i, j, "U", 1), 0, 1));
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_davidsonU_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_davidsonU_namespace::model_davidsonU stan_model;
#ifndef USING_R
