...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_btU");
    reader.add_event(83, 81, "end", "model_btU");
    return reader;
}
#include <stan_meta_header.hpp>
class model_btU
  : public stan::model::model_base_crtp<model_btU> {
private:
        int N_total;
        std::vector<int> y;
        int N_players;
        ...
        double prior_U_std;
public:
    model_btU(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_btU_namespace::model_btU";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_btU_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_btU_namespace::model_btU stan_model;
#ifndef USING_R
