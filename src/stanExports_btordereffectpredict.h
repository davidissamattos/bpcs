...
namespace model_btordereffectpredict_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_btordereffectpredict");
    reader.add_event(32, 30, "end", "model_btordereffectpredict");
    return reader;
}
#include <stan_meta_header.hpp>
class model_btordereffectpredict
  : public stan::model::model_base_crtp<model_btordereffectpredict> {
private:
        int N_newdata;
        int N_players;
        std::vector<int> player0_indexes;
        std::vector<int> player1_indexes;
        std::vector<int> z_player1;
public:
    model_btordereffectpredict(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_btordereffectpredict_namespace::model_btordereffectpredict";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "z_player1", "int", context__.to_vec(N_newdata));
            z_player1 = std::vector<int>(N_newdata, int(0));
            vals_i__ = context__.vals_i("z_player1");
            pos__ = 0;
            size_t z_player1_k_0_max__ = N_newdata;
            for (size_t k_0__ = 0; k_0__ < z_player1_k_0_max__; ++k_0__) {
                z_player1[k_0__] = vals_i__[pos__++];
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_btordereffectpredict_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_btordereffectpredict";
    }
...
typedef model_btordereffectpredict_namespace::model_btordereffectpredict stan_model;
#ifndef USING_R
