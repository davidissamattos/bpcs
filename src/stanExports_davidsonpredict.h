...
namespace model_davidsonpredict_namespace {
using std::istream;
using std::string;
...
class model_davidsonpredict
  : public stan::model::model_base_crtp<model_davidsonpredict> {
private:
        int N_newdata;
        int N_players;
...
public:
    model_davidsonpredict(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_davidsonpredict_namespace::model_davidsonpredict";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_davidsonpredict_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_davidsonpredict_namespace::model_davidsonpredict stan_model;
#ifndef USING_R
