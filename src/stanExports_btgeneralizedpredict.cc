...
#include "stanExports_btgeneralizedpredict.h"

RCPP_MODULE(stan_fit4btgeneralizedpredict_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_btgeneralizedpredict")
