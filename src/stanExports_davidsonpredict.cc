...
#include "stanExports_davidsonpredict.h"

RCPP_MODULE(stan_fit4davidsonpredict_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_davidsonpredict")
