...
#include "stanExports_davidsonordereffectpredict.h"

RCPP_MODULE(stan_fit4davidsonordereffectpredict_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_davidsonordereffectpredict")
