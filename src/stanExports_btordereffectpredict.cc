...
#include "stanExports_btordereffectpredict.h"

RCPP_MODULE(stan_fit4btordereffectpredict_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_btordereffectpredict")
