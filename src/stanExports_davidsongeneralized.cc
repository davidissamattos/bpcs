...
#include "stanExports_davidsongeneralized.h"

RCPP_MODULE(stan_fit4davidsongeneralized_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_davidsongeneralized")
