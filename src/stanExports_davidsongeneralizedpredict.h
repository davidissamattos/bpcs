...
namespace model_davidsongeneralizedpredict_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_davidsongeneralizedpredict");
    reader.add_event(56, 54, "end", "model_davidsongeneralizedpredict");
    return reader;
}
#include <stan_meta_header.hpp>
class model_davidsongeneralizedpredict
  : public stan::model::model_base_crtp<model_davidsongeneralizedpredict> {
private:
        int N_newdata;
        int N_players;
        ...
        matrix_d X;
public:
    model_davidsongeneralizedpredict(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_davidsongeneralizedpredict_namespace::model_davidsongeneralizedpredict";
    ...
    ~model_davidsongeneralizedpredict() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_davidsongeneralizedpredict_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_davidsongeneralizedpredict";
    }
...
typedef model_davidsongeneralizedpredict_namespace::model_davidsongeneralizedpredict stan_model;
#ifndef USING_R
