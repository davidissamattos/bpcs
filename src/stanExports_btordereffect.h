...
namespace model_btordereffect_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_btordereffect");
    reader.add_event(62, 60, "end", "model_btordereffect");
    return reader;
}
#include <stan_meta_header.hpp>
class model_btordereffect
  : public stan::model::model_base_crtp<model_btordereffect> {
private:
        int N_total;
        std::vector<int> y;
        int N_players;
        ...
        double prior_gm_mu;
public:
    model_btordereffect(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_btordereffect_namespace::model_btordereffect";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_btordereffect_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_btordereffect_namespace::model_btordereffect stan_model;
#ifndef USING_R
