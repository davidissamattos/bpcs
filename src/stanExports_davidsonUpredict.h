...
namespace model_davidsonUpredict_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_davidsonUpredict");
    reader.add_event(52, 50, "end", "model_davidsonUpredict");
    return reader;
}
#include <stan_meta_header.hpp>
class model_davidsonUpredict
  : public stan::model::model_base_crtp<model_davidsonUpredict> {
private:
        int N_newdata;
        int N_players;
...
public:
    model_davidsonUpredict(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_davidsonUpredict_namespace::model_davidsonUpredict";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_davidsonUpredict_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_davidsonUpredict_namespace::model_davidsonUpredict stan_model;
#ifndef USING_R
