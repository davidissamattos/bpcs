...
#include "stanExports_davidsonordereffect.h"

RCPP_MODULE(stan_fit4davidsonordereffect_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_davidsonordereffect")
