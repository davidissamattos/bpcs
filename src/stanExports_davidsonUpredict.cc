...
#include "stanExports_davidsonUpredict.h"

RCPP_MODULE(stan_fit4davidsonUpredict_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_davidsonUpredict")
