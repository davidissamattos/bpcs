...
We can see here that the best performing model was the Davidson model with order effect model (lowest WAIC), although very close to the davidson without order effect.


# Final remarks

In this vignette, we looked at 4 different models. However, we have not explored the impact of different priors in the model performance. 
