...
`r badge_license('MIT', color='yellow')` `r badge_last_commit("davidissamattos/bpcs")` `r badge_lifecycle("stable")` `r badge_code_size("davidissamattos/bpcs")` `r badge_devel("davidissamattos/bpcs", "blue")` `r badger::badge_cran_release('bpcs', color="blue")` `r badge_codecov("davidissamattos/bpcs")` [![R build status](https://github.com/davidissamattos/bpcs/workflows/R-CMD-check/badge.svg)](https://github.com/davidissamattos/bpcs/actions)
...
-   For general installation of Stan and RStan see: <https://github.com/stan-dev/rstan>
